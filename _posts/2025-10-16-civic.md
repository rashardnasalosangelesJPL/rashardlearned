...
Docs [Monitoring Publicly Available Services](https://assets.nagios.com/downloads/nagioscore/docs/nagioscore/4/en/monitoring-publicservices.html) [RAshard Fork @nagios](https://rashardsdata.github.io/nagioscore/) ### @meta convo with @TheSpaceDevs @nasa-jpl 
